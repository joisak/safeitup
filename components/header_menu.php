...
<div class="container header-nav <?php if(is_single()){ echo 'panel'; } ?>">
    <div class="row align-middle topbar">
        <div class="logo column small-2">
            ...
            <!-- <a href="<?php if(is_single()){ echo get_home_url() . '/'; }else{ echo '#safeitup'; }?>"><img class="logo-dark" src="<? echo get_template_directory_uri();?>/img/SafeITUp_black.png"></a> -->
            <a href="<?php if(is_single()){ echo get_home_url() . '/'; }else{ echo '#safeitup'; }?>"><img class="logo-dark" src="<? echo $image[0]?>"></a>            
