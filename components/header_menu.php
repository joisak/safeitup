...
<div class="container header-nav <?php if(is_single()){ echo 'panel'; } ?>">
    <div class="row align-middle topbar">
        <div class="logo column small-2">
            <a href="<?php if(is_single()){ echo '/'; }else{ echo '#safeitup'; }?>"><img class="logo-white" src="<? echo $image[0]?>"></a>            
            <a href="<?php if(is_single()){ echo '/'; }else{ echo '#safeitup'; }?>"><img class="logo-dark"src="<? echo get_template_directory_uri();?>/img/SafeITUp.svg"></a>
        </div>
